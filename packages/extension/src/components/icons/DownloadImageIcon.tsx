...
const DownloadImageIcon: Component<DownloadImageIconProps> = () => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="currentColor"
        fill-rule="evenodd"
        d="M17.5 2c-2.121 0-3.182 0-3.841.659C13 3.318 13 4.379 13 6.5c0 2.121 0 3.182.659 3.841c.659.659 1.72.659 3.841.659c2.121 0 3.182 0 3.841-.659C22 9.682 22 8.621 22 6.5c0-2.121 0-3.182-.659-3.841C20.682 2 19.621 2 17.5 2Zm2.03 5.53l-1.5 1.5a.75.75 0 0 1-1.06 0l-1.5-1.5a.75.75 0 0 1 1.06-1.06l.22.22V4.5a.75.75 0 0 1 1.5 0v2.19l.22-.22a.75.75 0 1 1 1.06 1.06Z"
        clip-rule="evenodd"
      />
    </svg>
  );
